        ...
        <div class="main-box d-flex  d-flex flex-md-row flex-wrap justify-content-center">
            ...
            <div class=" form-box col-md-5 col-sm-12" id="main">
                <div class="button-box w-75" id="buttons">
                    <div id="btn1"></div>
                    <button type="button" id="btn_login" class="toggle-btn" onclick="login1()">Log
                        In</button>

                    <button type="button" id="btn_signup" class="toggle-btn" onclick="register1()">Sign
                        up</button>
                </div>
                <div class="icon-box">
                ...
                if (isset($_GET['error'])) {
                    ...
                    } else if ((($_GET['error']) == "invalidemail") || ($_GET['error'] == "invalidemail")) {
                ...
                ?>
                <form id="signup1" class="form-input-group" action="includes/signup.inc.php" method="post">
                ...
                <form id="login1" class="form-input-group" action="includes/login.inc.php" method="post">
                    <div class="inputWithIcon">
